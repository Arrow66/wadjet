...
**Find real remote jobs. Skip the scams. See the math.**  
Multi-agent AI verification for remote job listings  :  with full scoring transparency.

[Use Case](#what-problem-does-wadjet-solve) · [Quality Scores](#how-wadjet-identifies-good-quality-jobs) · [Agents](#how-the-agentic-investigation-works) · [Scoring Math](#point-calculations) · [Architecture](#architecture) · [Quick Start](#quick-start) · [Partner API](#partner-portal-api)
...
> **Points guide:** [docs/SCORES_EXPLAINED.md](docs/SCORES_EXPLAINED.md)  
...
## Partner Portal API - testing stage
...
| Doc                                                  | Contents                   |
| ---------------------------------------------------- | -------------------------- |
| [docs/SCORES_EXPLAINED.md](docs/SCORES_EXPLAINED.md) | Legitimacy, Remote Quality |
